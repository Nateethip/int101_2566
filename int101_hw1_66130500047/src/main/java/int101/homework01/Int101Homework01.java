...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
       System.out.println("Your BMI" + work03.MyUtil.CalculateBMI(60,160));
       System.out.println("Your average" + work03.MyUtil.average(7,8,9));
   }
   ...
   static void work04UseOfObjectClass() {
      ...
      */
      ...
      BankAccount bankAccount1 = new BankAccount(5,person1);
      
      Person person2 = new Person(2);
      BankAccount bankAccount2 = new BankAccount(6, person2);
